...
pub mod i_access_control_enumerable_upgradeable {
    ...
    pub static IACCESSCONTROLENUMERABLEUPGRADEABLE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct IAccessControlEnumerableUpgradeable<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IAccessControlEnumerableUpgradeable<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IAccessControlEnumerableUpgradeable<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IAccessControlEnumerableUpgradeable<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IAccessControlEnumerableUpgradeable<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IAccessControlEnumerableUpgradeable))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IAccessControlEnumerableUpgradeable<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    IACCESSCONTROLENUMERABLEUPGRADEABLE_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            IAccessControlEnumerableUpgradeableEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for IAccessControlEnumerableUpgradeable<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IAccessControlEnumerableUpgradeableEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(
                    IAccessControlEnumerableUpgradeableEvents::RoleAdminChangedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = RoleGrantedFilter::decode_log(log) {
                return Ok(
                    IAccessControlEnumerableUpgradeableEvents::RoleGrantedFilter(decoded),
                );
            }
            if let Ok(decoded) = RoleRevokedFilter::decode_log(log) {
                return Ok(
                    IAccessControlEnumerableUpgradeableEvents::RoleRevokedFilter(decoded),
                );
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for IAccessControlEnumerableUpgradeableEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::ethers::core::abi::AbiDecode for IAccessControlEnumerableUpgradeableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IAccessControlEnumerableUpgradeableCalls {
    ...
    impl ::core::fmt::Display for IAccessControlEnumerableUpgradeableCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for IAccessControlEnumerableUpgradeableCalls {
